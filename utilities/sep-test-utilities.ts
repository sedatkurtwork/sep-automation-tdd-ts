import { Page, Locator, test as base, TestInfo, expect } from "@playwright/test";
...
export async function verifyElementColor(
  element: Locator,
  ...
  console.log(
    `Color check → expected: ${expectedColor}, actual: ${actualColor}`
  );
